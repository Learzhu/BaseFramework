 ...
 * @used {@link }
 */
public class ThirdLevelFragment extends LazyLoadFragment {
    ...
    public static ThirdLevelFragment newInstance(String data) {
        ThirdLevelFragment fragment = new ThirdLevelFragment();
